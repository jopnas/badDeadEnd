...
// Loot
_foodItems          = ["bde_hatchet","bde_antibiotics","bde_ducttape","bde_ducttape_empty","bde_ducttape_6","bde_ducttape_5","bde_ducttape_4","bde_ducttape_3","bde_ducttape_2","bde_ducttape_1","bde_vitamines","bde_bottleuseless","bde_bottleempty","bde_bottlefilled","bde_bottleclean","bde_canteenempty","bde_canteenfilled"];
// Military Lootlists
